    ...
    return ( 
        <div>
            <div className="bottom-0 bg-secondary md:flex justify-center py-16 px-10 md:px-20 lg:px-40 xl:px-60 gap-10 border-b border-gray">
                ...
                <div className="md:w-1/3">
                    <div className="pb-5">
                        ...
                        <ul>
                            <li className="text-gray-300 font-light leading-6 hover:text-primary"><a href="/">About</a></li>
                            <li className="text-gray-300 font-light leading-6 hover:text-primary"><a href="/">Cart</a></li>
                            <li className="text-gray-300 font-light leading-6 hover:text-primary"><a href="/">Checkout</a></li>
                            <li className="text-gray-300 font-light leading-6 hover:text-primary"><a href="/">Contact</a></li>
                            <li className="text-gray-300 font-light leading-6 hover:text-primary"><a href="/">Home</a></li>
                            <li className="text-gray-300 font-light leading-6 hover:text-primary"><a href="/">My account</a></li>
                            <li className="text-gray-300 font-light leading-6 hover:text-primary"><a href="/">Shop</a></li>
                        </ul>
                    </div>
                    <div className="pb-5">
                        <h2 className="text-2xl font-bold text-white pb-5">Site Links</h2>
                        <ul>
                            <li className="text-gray-300 font-light leading-6 hover:text-primary"><a href="/">Privacy Policy</a></li>
                            <li className="text-gray-300 font-light leading-6 hover:text-primary"><a href="/">Shipping Details</a></li>
                            <li className="text-gray-300 font-light leading-6 hover:text-primary"><a href="/">Offers Coupons</a></li>
                            <li className="text-gray-300 font-light leading-6 hover:text-primary"><a href="/">Terms & Conditions</a></li>
                        </ul>
                    </div>
                ...
                <div className="md:w-1/3">
                    <div className="pb-5">
                        ...
                        <p className="text-gray-300 leading-8 text-left font-light py-5">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec aliquam gravida sollicitudin. Praesent porta enim mi, non tincidunt libero interdum sit amet.</p>
                    </div>
                    <div className="pb-5">
            ...
            <div className="flex justify-center justify-between bg-secondary py-10 px-10 md:px-20 lg:px-40 xl:px-60">
                <p className="text-gray-300 font-light leading-6">Copyright © 2023 | Organic Store</p>
                <div>
